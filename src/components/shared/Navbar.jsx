    ...
    return (
        <nav className='shadow'>
            <div className='flex justify-between gap-4 items-center py-2 container mx-auto'>
                ...
                <ul className='flex justify-between gap-2 items-center md:mr-0 mr-5'>
                    {
                ...
                <button className='btn bg-purple-500 text-white hidden md:flex'><FaGithub />Contribute</button>
            </div>
        </nav>
    );
};
